...
import MisDonacionesTemplate from "../components/templates/misDonacionesTemplate";
...
const MisProyectos: FC = () => {
    ...
    return (
        <>
            <MainTemplate>
                <MisDonacionesTemplate campaigns={campaignsData} loading={loading}></MisDonacionesTemplate>
            </MainTemplate>
        </>
        )
}
